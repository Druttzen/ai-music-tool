...
export function pickProjectActionInput(
  ...
  return {
    ...
    sidecarAcestepAvailable: analyzers.sidecarAcestepAvailable,
    sidecarStemsMelbandAvailable: analyzers.sidecarStemsMelbandAvailable,
    sidecarVocalTransformAvailable: analyzers.sidecarVocalTransformAvailable,
...
export function pickWorkspaceContextExtras(
  ...
  return {
    ...
    cancelMusicGeneration: analyzers.cancelMusicGeneration,
    cancelSongGeneration: analyzers.cancelSongGeneration,
    exportEnhancedAudio: analyzers.exportEnhancedAudio,
    generateMusicCanCancel: analyzers.generateMusicCanCancel,
    generateMusicBusy: analyzers.generateMusicBusy,
    generateMusicCancelRequested: analyzers.generateMusicCancelRequested,
    generateMusicFromPrompt: analyzers.generateMusicFromPrompt,
    generateSongCanCancel: analyzers.generateSongCanCancel,
    generateSongBusy: analyzers.generateSongBusy,
    generateSongCancelRequested: analyzers.generateSongCancelRequested,
    ...
    stemSeparationStems: analyzers.stemSeparationStems,
    sidecarGenerateAvailable: analyzers.sidecarGenerateAvailable,
    sidecarAcestepAvailable: analyzers.sidecarAcestepAvailable,
    sidecarStemsMelbandAvailable: analyzers.sidecarStemsMelbandAvailable,
    sidecarVocalTransformAvailable: analyzers.sidecarVocalTransformAvailable,
