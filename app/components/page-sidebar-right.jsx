  ...
  return (
    <aside className="space-y-4">
      ...
      {promptEngine === "Suno-like" ? (
        <GuidedFocusPanel panelId={GUIDED_PANEL_IDS.sunoValidator} column="right">
      ...
      <GuidedFocusPanel panelId={GUIDED_PANEL_IDS.sunoLanguageIndex} column="right">
        <SunoLanguageIndexPanel copyToClipboard={copyToClipboard} onApplyGenreAnchors={applyGenreAnchors} />
      </GuidedFocusPanel>

      <GuidedFocusPanel panelId={GUIDED_PANEL_IDS.history} column="right">
      ...
      <GuidedFocusPanel panelId={GUIDED_PANEL_IDS.trackScoring} column="right">
      ...
      {focused ? (
        <p className="text-[10px] leading-relaxed text-white/35">
          Extra reference panels are hidden until you need them or choose Show all tools.
        </p>
      ) : null}
    </aside>
  );
