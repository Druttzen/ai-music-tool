...
test.describe("MusicGen melody e2e", () => {
  ...
  test("melody-conditioned generate merges MG line into Style", async ({ page, context }) => {
    ...
    await expect(toast).toContainText(/MusicGen preview merged.*melody/i, { timeout: 180_000 });
