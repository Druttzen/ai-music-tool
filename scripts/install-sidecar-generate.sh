...
echo "Installing generate extra (torch + audiocraft) — this may take several minutes..."
"$VENV/bin/pip" install -e "$SIDECAR[generate]"
echo "Generate extra installed. Restart the sidecar and check GET /health for generate_available: true"
