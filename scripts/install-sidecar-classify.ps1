...
Write-Host "Installing classify extra (torch + transformers) - this may take several minutes..."
& "$venv\Scripts\pip" install -e "${sidecar}[classify]"
Write-Host "Done. Restart the sidecar and check GET /health for genre_available: true"
