...
Write-Host "Installing vision extra (torch + transformers + pillow) - this may take several minutes..."
& "$venv\Scripts\pip" install -e "${sidecar}[vision]"
Write-Host "Done. Restart the sidecar and check GET /health for vision_available: true"
Write-Host "Restart: npm run sidecar"
