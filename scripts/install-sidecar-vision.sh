...
echo "Installing vision extra (torch + transformers + pillow)…"
"$VENV/bin/pip" install -e "$SIDECAR[vision]"
echo "Vision extra installed. Restart the sidecar: npm run sidecar"
