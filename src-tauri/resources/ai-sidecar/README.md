...
- **Packaged Studio:** Addons **Install** can bootstrap a writable venv next to the app (`{install}/data/sidecar`) from bundled package sources when system Python 3.10–3.12 is available; the Studio then spawns that venv instead of the frozen binary.
